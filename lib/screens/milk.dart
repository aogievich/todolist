          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Необходимо купить молоко! Срочно необходимо купить молоко! Если не купить молоко, то произойдёт что-то страшное!',
                  style: TextStyle(
                    color: blColor,
                    fontSize: 14,
                  ),
...
var itemx = Item(2, 'Покупка молока');
    ...
    return Row(
      ...
      children: [
        ...
        Container(
            ...
            child:
                Icon(Icons.arrow_back_ios, size: 24, color: Color(0x55E5E5E5))),
        Container(
